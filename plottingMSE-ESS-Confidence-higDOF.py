...
# plt.plot(d_collect, np.sqrt(MSE_Z_escortAMIS_dof1) / true_Z, label="AHTIS, $\\nu=1$", marker="o")
# plt.plot(d_collect, np.sqrt(MSE_Z_escortAMIS_dof2) / true_Z, label="AHTIS, $\\nu=2$", marker="|")
plt.plot(d_collect, np.sqrt(MSE_Z_escortAMIS_dof3) / true_Z, label="AHTIS, $\\nu=3$", marker="v")
plt.plot(d_collect, np.sqrt(MSE_Z_escortAMIS_dof5) / true_Z, label="AHTIS, $\\nu=5$", marker="p")
plt.plot(d_collect, np.sqrt(MSE_Z_escortAMIS_dof10) / true_Z, label="AHTIS, $\\nu=10$", marker="*")
...
plt.plot(d_collect, np.sqrt(MSE_Z_adaptive) / true_Z, label="adaptive AHTIS", marker="x")
...
# plt.plot(d_collect, alphaESS_mean_escortAMIS_dof1, label="AHTIS, $\\nu=1$", marker="o")
# plt.plot(d_collect, alphaESS_mean_escortAMIS_dof2, label="AHTIS, $\\nu=2$", marker="|")
plt.plot(d_collect, alphaESS_mean_escortAMIS_dof3, label="AHTIS, $\\nu=3$", marker="v")
plt.plot(d_collect, alphaESS_mean_escortAMIS_dof5, label="AHTIS, $\\nu=5$", marker="p")
plt.plot(d_collect, alphaESS_mean_escortAMIS_dof10, label="AHTIS, $\\nu=1$0", marker="*")
...
plt.plot(d_collect, alphaESS_mean_adaptive, label="adaptive AHTIS", marker="x")
...
# plt.fill_between(d_collect, conf_lb_escortAMIS_dof1 / true_Z, conf_ub_escortAMIS_dof1 / true_Z, alpha=0.5, label="AHTIS, $\\nu=1$")
# plt.fill_between(d_collect, conf_lb_escortAMIS_dof2 / true_Z, conf_ub_escortAMIS_dof2 / true_Z, alpha=0.5, label="AHTIS, $\\nu=2$")
plt.fill_between(d_collect, conf_lb_escortAMIS_dof3 / true_Z, conf_ub_escortAMIS_dof3 / true_Z, alpha=0.5, label="AHTIS, $\\nu=3$")
plt.fill_between(d_collect, conf_lb_escortAMIS_dof5 / true_Z, conf_ub_escortAMIS_dof5 / true_Z, alpha=0.5, label="AHTIS, $\\nu=5$")
plt.fill_between(d_collect, conf_lb_escortAMIS_dof10 / true_Z, conf_ub_escortAMIS_dof10 / true_Z, alpha=0.5, label="AHTIS, $\\nu=10$")
