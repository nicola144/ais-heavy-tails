...
for dimension in dimensionCollect:
    folder = "./results/data_to_send/100Runs_dof" + str(dofTarg) + "_d" + str(dimension) + "_cond" + str(conditionNumber)
...
for alg in algCollect:
    ...
    for dimension in dimensionCollect:
        folder = "./results/data_to_send/100Runs_dof" + str(dofTarg) + "_d" + str(dimension) + "_cond" + str(conditionNumber) + "/" + alg[
            'name']
...
plt.fill_between(d_collect, alphaESS_mean_escortAMIS_dof3 - alphaESS_std_escortAMIS_dof3,
                 alphaESS_mean_escortAMIS_dof3 + alphaESS_std_escortAMIS_dof3, alpha=0.2)
plt.fill_between(d_collect, alphaESS_mean_escortAMIS_dof5 - alphaESS_std_escortAMIS_dof5,
                 alphaESS_mean_escortAMIS_dof5 + alphaESS_std_escortAMIS_dof5, alpha=0.2)
plt.fill_between(d_collect, alphaESS_mean_escortAMIS_dof10 - alphaESS_std_escortAMIS_dof10,
                 alphaESS_mean_escortAMIS_dof10 + alphaESS_std_escortAMIS_dof10, alpha=0.2)

plt.fill_between(d_collect, alphaESS_mean_AMIS_dof3 - alphaESS_std_AMIS_dof3,
                 alphaESS_mean_AMIS_dof3 + alphaESS_std_AMIS_dof3, alpha=0.2)
plt.fill_between(d_collect, alphaESS_mean_AMIS_dof5 - alphaESS_std_AMIS_dof5,
                 alphaESS_mean_AMIS_dof5 + alphaESS_std_AMIS_dof5, alpha=0.2)
plt.fill_between(d_collect, alphaESS_mean_AMIS_dof10 - alphaESS_std_AMIS_dof10,
                 alphaESS_mean_AMIS_dof10 + alphaESS_std_AMIS_dof10, alpha=0.2)

plt.fill_between(d_collect, alphaESS_mean_adaptive - alphaESS_std_adaptive,
                 alphaESS_mean_adaptive + alphaESS_std_adaptive, alpha=0.2)
...
plt.fill_between(d_collect, conf_lb_escortAMIS_dof3 / true_Z, conf_ub_escortAMIS_dof3 / true_Z, alpha=0.5,
                 label="escort AMIS, $\\nu=3$")
plt.fill_between(d_collect, conf_lb_escortAMIS_dof5 / true_Z, conf_ub_escortAMIS_dof5 / true_Z, alpha=0.5,
                 label="escort AMIS, $\\nu=5$")
plt.fill_between(d_collect, conf_lb_escortAMIS_dof10 / true_Z, conf_ub_escortAMIS_dof10 / true_Z, alpha=0.5,
                 label="escort AMIS, $\\nu=10$")
...
plt.fill_between(d_collect, conf_lb_AMIS_dof10 / true_Z, conf_ub_AMIS_dof10 / true_Z, alpha=0.5,
                 label="AMIS, $\\nu=10$")
